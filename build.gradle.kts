...
dependencies {
    ...
    implementation("com.github.MarcelloSpagnoli:TiledReader:19e69ad")
    implementation("com.github.ettore-spaccini:TiledReader:Tag")
...
application {
    ...
    mainClass.set("mindescape.app.MindEscape")
}
