...
public final class PlayerView {
    ...
    public PlayerView(final Point2D pos) {
        ...
        spriteMapper.put(UserInput.DOWN, List.of(
            ...
            image.getSubimage(DOWN_POSITION + 1, 0, SPRITE_SIZE, SPRITE_SIZE))
        );
        spriteMapper.put(UserInput.UP, List.of(
            image.getSubimage(UP_POSITION, 0, SPRITE_SIZE, SPRITE_SIZE),
            image.getSubimage(UP_POSITION + 1, 0, SPRITE_SIZE, SPRITE_SIZE))
        );
        spriteMapper.put(UserInput.RIGHT, List.of(
            image.getSubimage(RIGHT_POSITION, 0, SPRITE_SIZE, SPRITE_SIZE),
            image.getSubimage(RIGHT_POSITION + 1, 0, SPRITE_SIZE, SPRITE_SIZE))
        );
        spriteMapper.put(UserInput.LEFT, List.of(
            image.getSubimage(LEFT_POSITION, 0, SPRITE_SIZE, SPRITE_SIZE),
            image.getSubimage(LEFT_POSITION + 1, 0, SPRITE_SIZE, SPRITE_SIZE))
        );
